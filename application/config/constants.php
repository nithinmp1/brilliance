...
// echo APPPATH.'../assets/';die;
defined('ASSET_DIR')           OR define('ASSET_DIR', APPPATH.'../assets/'); // directory of views
defined('API_URL')           OR define('API_URL', 'http://localhost/brilliance/api/');
defined('API_VERSION')           OR define('API_VERSION', 'v1');
defined('PREFIX')           OR define('PREFIX', 'BC');
